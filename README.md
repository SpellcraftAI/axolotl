...
- Lambda Labs
  ...
  Run `bash scripts/lambda_labs_setup.py` from the project directory to handle
  setup for Lambda Labs VMs automatically.
  
  This script will upgrade and configure Python 3.9, remove system versions of
  PyTorch packages & reinstall them via pip, and refresh the Jupyter kernel.
